...
function AchievementChip({ achievement, isLatest, isUnlocked }: AchievementChipProps) {
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-sm font-semibold text-ink">
              {latestUnlock ? latestUnlock.name : "No unlocks yet"}
            </p>
          </div>
        </div>

        <div className="mt-4 min-w-0">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Unlocked</p>
          <div className="mt-2 flex min-w-0 flex-wrap gap-2" data-testid="unlocked-achievements">
            {unlockedAchievements.length > 0 ? (
              ...
              <span className="text-sm text-muted">No unlocks yet</span>
            )}
          </div>
        </div>

        <div className="mt-4 min-w-0">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Locked</p>
